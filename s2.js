  ...
  if (
    ...
    if (ball_coord.left <= board_coord.left) {
      ...
      if(score_2.innerHTML=="10"){
        ...
        startMedium=false;
        startFast=false;
        message.innerHTML='Right side player wins!<button onclick="resetBtn()" id="reset">Reset</button>';
        score_2.innerHTML="0";
        score_1.innerHTML="0";
        gameState='stop';
        gameOver=true;
      ...
      if(score_1.innerHTML=="10"){
        ...
        startMedium=false;
        startFast=false;
        message.innerHTML='Left side player wins!<button onclick="resetBtn()" id="reset">Reset</button>';
        score_2.innerHTML="0";
        score_1.innerHTML="0";
        gameState='stop';
        gameOver=true;
